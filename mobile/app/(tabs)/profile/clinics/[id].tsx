...
export default function ClinicPublicProfileScreen() {
  ...
  const requestAppointment = useMutation({
    ...
    onSuccess: () => {
      ...
      setReason('')
      setSuccessMessage('Randevu talebiniz kliniğe iletildi. Klinik onayladığında randevularınızda görünecek.')
    },
  })
...
const styles = StyleSheet.create({
  ...
  successBanner: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: Colors.primaryBg, borderColor: Colors.primaryBorder, borderWidth: 1, borderRadius: Radius.lg, padding: Spacing.md, marginTop: Spacing.lg },
